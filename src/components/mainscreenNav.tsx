...
const MainScreenNav = (props: MainScreenNavProps) => {
  ...
  return (
    <div className="flex bg-gray-300 dark:bg-gray-600 px-2 py-1 justify-between items-center">
      <>
        Showing 1 - {pageCount} of {pageCount}
      </>
      <div className="flex gap-2 items-center">
        <Button className="h-6 bg-transparent text-black dark:text-white hover:bg-transparent">
          First
        </Button>
